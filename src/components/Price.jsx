        ...
        {pricingOptions.map((option, index) => (
          <div key={index} className="w-full p-2 sm:w-1/2 lg:w-1/3">
            <div className="p-10 border border-x-neutral-700 rounded-xl">
              ...
              <a
                href="#"
                className="inline-flex items-center justify-center w-full h-12 p-5 mt-20 text-xl tracking-tight transition duration-200 border border-orange-900 rounded-lg hover:bg-orange-900"
              >
                Subscribe
              </a>
            </div>
