    ...
    <nav className="sticky top-0 z-50 py-3 border-b backdrop-blur-lg border-neutral-700/80">
      <div className="container relative px-4 mx-auto text-sm">
        ...
        {mobileDrawerOpen && (
            ...
            <div className="fixed right-0 z-20 flex flex-col justify-center w-full p-12 bg-neutral-900 items center lg:hidden">
            <ul>
              {navItems.map((item, index)=> (
            ...
            <div className="flex flex-col items-center justify-center space-x-6">
               <a href="#" className='px-3 py-2 mb-2 border rounded-md'>
                Sign In
               </a>
